    ...
    return (
        <>
            ...
            <div className="h-dvh flex flex-col justify-center items-center">
                <img src={imgStarShip} alt="starship" className="w-35 mb-7" />

                <div 
                    className={`relative w-75 h-35 rounded-3xl border-3 border-dashed text-center ${
                ...
                >
                    <img src={imgDocument} alt="" className="w-8 invert mb-4" />
                    <h6 className="text-white text-sm font-bold mb-1">
